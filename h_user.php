...
<head>
    ...
    <title>Manajemen User - DandyInventory</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">DandyInventory</span>
            </a>
    ...
    <div class="col-12">
        ...
        <input type="text" class="form-control" name="kd_kat" required>
    </div>

    <div class="col-12">
        <label class="form-label">Nama Kategori</label>
        <input type="text" class="form-control" name="nm_kat" required>
    </div>
